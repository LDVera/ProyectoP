    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="contenedor_asignatura_alta col-4">
          <form id="combo" name="combo" action="../conexion/identificadorFore.php" method="POST">
			      <div>Selecciona asignatura : 
              <select name="cbx_asignatura" id="cbx_asignatura">
            ...
            <div class="contenedorFore col-3">
              <div>
               ID:
               <input type="text">
            </div>
